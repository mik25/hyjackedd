...
JACKETT_URL: str = os.environ.get("JACKETT_URL", "https://mikmc-jackett.elfhosted.com")
JACKETT_API_KEY: str = os.environ.get("JACKETT_API_KEY", "pr3hehabdz8xz605svarhpeel4t38slm")
...
JACKETT_INDEXERS_LIST: list[str] = os.environ.get(
    "JACKETT_INDEXERS",
    "aither-api,bitsearch,concen,digitalcore,extremlymtorrents,hawke-uno,morethantv-api,skipthetrailers,solidtorrents,torrentseeds-api,torrentz2nz,tvchaosuk,xtremebytes",
).split(",")
